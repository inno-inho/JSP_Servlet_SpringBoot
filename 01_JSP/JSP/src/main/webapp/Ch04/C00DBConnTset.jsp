...
<%@ page import = "java.sql.*, java.util.*" %>	<!-- util, sql관련 경로 불러오기 -->
<%@ page import = "Ch04.*" %>	<!-- JAVA의 Ch04에 있는 클래스도 전부 불러오기 -->    
		...
		try {
			...
			if(rs!=null) {
				while(rs.next()) {
					...
					System.out.println(rs.getString("col1")+"_");		
					System.out.println(rs.getString("col2")+"_");		
